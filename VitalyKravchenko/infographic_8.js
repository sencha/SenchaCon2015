...
Ext.define('Infographic.View', {
    ...
    title: 'Infographic: Step 8 (preselecting a state, adding country region bracket lines)',
    floating: true,
    constrain: true,
    ...
    items: [
        ...
        // so the larger portion of the infographic is only rendered once.
        {
            ...
            series: [
                {
                    ...
                    renderer: 'onHighlightSliceRender' // TODO 2
                },
                {
            ...
            listeners: {
                ...
                afterrender: 'onAfterRender' // TODO 1
            }
        },
        {
            xtype: 'cartesian',
