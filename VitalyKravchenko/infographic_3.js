...
Ext.define('Infographic.View', {
    ...
    title: 'Infographic: Step 3 (labels, slice and label renderers, "rotation" config)',
    floating: true,
    constrain: true,
    ...
    items: [
        {
            ...
            series: {
                ...
                label: { // TODO 1
                    ...
                    // renderer: 'onLabelRender2012' // TODO 2
                }
            }
        }
    ]
